...
var G__49982 = o;
goog.object.set(G__49982,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__50197__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__50197 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__50198__i = 0, G__50198__a = new Array(arguments.length -  0);
while (G__50198__i < G__50198__a.length) {G__50198__a[G__50198__i] = arguments[G__50198__i + 0]; ++G__50198__i;}
  args = new cljs.core.IndexedSeq(G__50198__a,0,null);
} 
return G__50197__delegate.call(this,args);};
G__50197.cljs$lang$maxFixedArity = 0;
G__50197.cljs$lang$applyTo = (function (arglist__50199){
var args = cljs.core.seq(arglist__50199);
...
var G__49991 = o;
goog.object.set(G__49991,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__50206__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__50207__i < G__50207__a.length) {G__50207__a[G__50207__i] = arguments[G__50207__i + 0]; ++G__50207__i;}
  args = new cljs.core.IndexedSeq(G__50207__a,0,null);
} 
...
var G__50011 = props;
var G__50011__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__50011,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__50011);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__50011__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props)));
} else {
return G__50011__$1;
}
});
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__50021 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__50021,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__50021;
}
})(),id_class);
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__50042){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50043__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return (jsprops.onChange = (function (p1__50057_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__50057_SHARP_);
}));
} else {
return null;
}
...
var vec__50073 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50073,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50073,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50073,(2),null);
...
var temp__5739__auto___50264 = reagent.impl.template.key_from_vec(v);
if((temp__5739__auto___50264 == null)){
} else {
var key_50266 = temp__5739__auto___50264;
(jsprops.key = key_50266);
}
...
var temp__5739__auto___50276 = reagent.impl.template.key_from_vec(argv);
if((temp__5739__auto___50276 == null)){
} else {
var key_50277 = temp__5739__auto___50276;
(jsprops.key = key_50277);
}
...
var G__50118 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,component,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__50118) : reagent.impl.template.as_element.call(null,G__50118));
} else {
var temp__5739__auto___50286 = reagent.impl.template.get_key(cljs.core.meta(argv));
if((temp__5739__auto___50286 == null)){
} else {
var key_50287 = temp__5739__auto___50286;
(jsprops.key = key_50287);
}
...
var G__50130 = n;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("",G__50130)){
return x;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__50130)){
return x;
} else {
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq50134){
var G__50135 = cljs.core.first(seq50134);
var seq50134__$1 = cljs.core.next(seq50134);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__50135,seq50134__$1);
}));
...
break;
default:
var G__50308 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__50308;
continue;
...
var ctx = ({});
var vec__50170 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50170,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50170,(1),null);
...
var G__50181 = (cljs.core.count(argv) - first_child);
switch (G__50181) {
case (0):
