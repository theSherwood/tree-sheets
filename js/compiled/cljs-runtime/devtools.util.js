...
var len__4736__auto___45676 = arguments.length;
var i__4737__auto___45677 = (0);
while(true){
if((i__4737__auto___45677 < len__4736__auto___45676)){
args__4742__auto__.push((arguments[i__4737__auto___45677]));

var G__45679 = (i__4737__auto___45677 + (1));
i__4737__auto___45677 = G__45679;
continue;
} else {
}
break;
...
var _STAR_print_newline_STAR__orig_val__45451_45682 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__45452_45683 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__45453_45684 = true;
var _STAR_print_fn_STAR__temp_val__45454_45685 = (function (x__4668__auto__){
return sb__4667__auto__.append(x__4668__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__45453_45684);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__45454_45685);

try{var _STAR_print_level_STAR__orig_val__45459_45686 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__45460_45687 = (300);
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__45460_45687);

try{cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.pprint.pprint,args);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__45459_45686);
}}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__45452_45683);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__45451_45682);
}
...
/** @this {Function} */
(devtools.util.pprint_str.cljs$lang$applyTo = (function (seq45444){
...
var new_formatters = current_formatters.filter((function (p1__45497_SHARP_){
return (!(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(detector,p1__45497_SHARP_)));
}));
...
var G__45519_45723 = f;
var target__41145__auto___45724 = G__45519_45723;
if(cljs.core.truth_(target__41145__auto___45724)){
} else {
throw (new Error(["Assert failed: ",["unable to locate object path ",null," in ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__45519_45723)].join(''),"\n","target__41145__auto__"].join('')));
}

(target__41145__auto___45724["toString"] = (function (){
...
var G__45536_45730 = "%c%s";
var G__45537_45731 = "color:transparent";
var G__45538_45732 = devtools.util.make_detection_printer();
(f.cljs$core$IFn$_invoke$arity$3 ? f.cljs$core$IFn$_invoke$arity$3(G__45536_45730,G__45537_45731,G__45538_45732) : f.call(null,G__45536_45730,G__45537_45731,G__45538_45732));
...
var args__4742__auto__ = [];
var len__4736__auto___45750 = arguments.length;
var i__4737__auto___45751 = (0);
while(true){
if((i__4737__auto___45751 < len__4736__auto___45750)){
args__4742__auto__.push((arguments[i__4737__auto___45751]));

var G__45752 = (i__4737__auto___45751 + (1));
i__4737__auto___45751 = G__45752;
continue;
} else {
}
break;
...
var vec__45584 = devtools.util.feature_list_display(installed_features,feature_groups);
var fmt_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45584,(0),null);
var fmt_params = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45584,(1),null);
return devtools.util.wrap_with_custom_formatter_detection_BANG_((function() { 
var G__45755__delegate = function (add_fmt,add_args){
...
var G__45755 = function (add_fmt,var_args){
var add_args = null;
if (arguments.length > 1) {
var G__45762__i = 0, G__45762__a = new Array(arguments.length -  1);
while (G__45762__i < G__45762__a.length) {G__45762__a[G__45762__i] = arguments[G__45762__i + 1]; ++G__45762__i;}
  add_args = new cljs.core.IndexedSeq(G__45762__a,0,null);
} 
return G__45755__delegate.call(this,add_fmt,add_args);};
G__45755.cljs$lang$maxFixedArity = 1;
G__45755.cljs$lang$applyTo = (function (arglist__45763){
var add_fmt = cljs.core.first(arglist__45763);
var add_args = cljs.core.rest(arglist__45763);
return G__45755__delegate(add_fmt,add_args);
});
...
/** @this {Function} */
(devtools.util.display_banner_BANG_.cljs$lang$applyTo = (function (seq45565){
var G__45566 = cljs.core.first(seq45565);
var seq45565__$1 = cljs.core.next(seq45565);
var G__45567 = cljs.core.first(seq45565__$1);
var seq45565__$2 = cljs.core.next(seq45565__$1);
var G__45568 = cljs.core.first(seq45565__$2);
var seq45565__$3 = cljs.core.next(seq45565__$2);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__45566,G__45567,G__45568,seq45565__$3);
}));
...
var seq__45622 = cljs.core.seq(features);
var chunk__45623 = null;
var count__45624 = (0);
var i__45625 = (0);
while(true){
if((i__45625 < count__45624)){
var feature = chunk__45623.cljs$core$IIndexed$_nth$arity$2(null,i__45625);
...
var G__45768 = seq__45622;
var G__45769 = chunk__45623;
var G__45770 = count__45624;
var G__45771 = (i__45625 + (1));
seq__45622 = G__45768;
chunk__45623 = G__45769;
count__45624 = G__45770;
i__45625 = G__45771;
continue;
} else {
...
var c__4556__auto__ = cljs.core.chunk_first(seq__45622__$1);
var G__45772 = cljs.core.chunk_rest(seq__45622__$1);
var G__45773 = c__4556__auto__;
var G__45774 = cljs.core.count(c__4556__auto__);
var G__45775 = (0);
seq__45622 = G__45772;
chunk__45623 = G__45773;
count__45624 = G__45774;
i__45625 = G__45775;
continue;
} else {
var feature = cljs.core.first(seq__45622__$1);
if(cljs.core.not(cljs.core.some(cljs.core.PersistentHashSet.createAsIfByAssoc([feature]),known_features))){
devtools.context.get_console.call(null).warn(devtools.util.unknown_feature_msg.call(null,feature,known_features,lib_info));
} else {
}
...
var G__45779 = cljs.core.next(seq__45622__$1);
var G__45780 = null;
var G__45781 = (0);
var G__45782 = (0);
seq__45622 = G__45779;
chunk__45623 = G__45780;
count__45624 = G__45781;
i__45625 = G__45782;
continue;
}
} else {
...
if(cljs.core.truth_(temp__5733__auto__)){
var o45665 = temp__5733__auto__;
return (o45665["version"]);
} else {
return null;
}
})() == null);
