...
var len__4736__auto___42215 = arguments.length;
var i__4737__auto___42216 = (0);
while(true){
if((i__4737__auto___42216 < len__4736__auto___42215)){
args__4742__auto__.push((arguments[i__4737__auto___42216]));

var G__42217 = (i__4737__auto___42216 + (1));
i__4737__auto___42216 = G__42217;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq42151){
var G__42152 = cljs.core.first(seq42151);
var seq42151__$1 = cljs.core.next(seq42151);
var G__42153 = cljs.core.first(seq42151__$1);
var seq42151__$2 = cljs.core.next(seq42151__$1);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__42152,G__42153,seq42151__$2);
}));
...
var map__42182 = opts;
var map__42182__$1 = (((((!((map__42182 == null))))?(((((map__42182.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__42182.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__42182):map__42182);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42182__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e42187){var _e__41155__auto__ = e42187;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e42189){var _e__41155__auto__ = e42189;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__42197 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__42198 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__42198);

try{var map__42199 = opts;
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42199__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__42197);
}});
...
var temp__5733__auto___42257 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___42257)){
var managed_print_level_42261 = temp__5733__auto___42257;
var _STAR_print_level_STAR__orig_val__42211_42262 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__42212_42263 = managed_print_level_42261;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__42212_42263);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__42209_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__42209_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__42211_42262);
}} else {
job_fn();
}
