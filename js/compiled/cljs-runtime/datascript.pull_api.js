...
var depth = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58567__$1,new cljs.core.Keyword(null,"depth","depth",1768663640));
var seen = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58567__$1,new cljs.core.Keyword(null,"seen","seen",-518999789));
...
var G__58579 = new cljs.core.Keyword(null,"kvps","kvps",65308317).cljs$core$IFn$_invoke$arity$1(frame);
var G__58579__$1 = (((G__58579 == null))?null:cljs.core.persistent_BANG_(G__58579));
if((G__58579__$1 == null)){
return null;
} else {
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(G__58579__$1,key);
}
});
...
datascript.pull_api.pull_recursion_frame = (function datascript$pull_api$pull_recursion_frame(db,p__58586){
...
var frame = first__58589;
var frames = seq__58588__$1;
...
var results = (function (){var G__58590 = new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(frame);
if(cljs.core.seq(kvps)){
return cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(G__58590,kvps);
} else {
return G__58590;
}
})();
...
var recursion = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58591__$1,new cljs.core.Keyword(null,"recursion","recursion",-749738765));
var pattern = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58591__$1,new cljs.core.Keyword(null,"pattern","pattern",242135423));
...
var pattern_58676 = (new datascript.pull_parser.PullSpec(true,cljs.core.PersistentArrayMap.EMPTY,null,null,null));
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(datascript.pull_api.subpattern_frame(pattern_58676,eids,multi_QMARK_,attr_key),new cljs.core.Keyword(null,"recursion","recursion",-749738765),rec);
});
datascript.pull_api.pull_attr_datoms = (function datascript$pull_api$pull_attr_datoms(db,attr_key,attr,eid,forward_QMARK_,datoms,opts,p__58598){
...
var parent = first__58601;
var frames = seq__58600__$1;
...
var found = cljs.core.not_empty((function (){var G__58602 = datoms;
if(cljs.core.truth_(limit)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.take.cljs$core$IFn$_invoke$arity$1(limit),G__58602);
} else {
return G__58602;
}
})());
...
var as_value = (function (){var G__58612 = datom_val;
if(ref_QMARK_){
return cljs.core.comp.cljs$core$IFn$_invoke$arity$2((function (p1__58596_SHARP_){
return cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword("db","id","db/id",-1388397098)],[p1__58596_SHARP_]);
}),G__58612);
} else {
return G__58612;
}
...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,cljs.core.update.cljs$core$IFn$_invoke$arity$5(parent,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,attr_key__$1,(function (){var G__58613 = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1(as_value),found);
if(single_QMARK_){
return cljs.core.first(G__58613);
} else {
return G__58613;
}
})()));
...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,(function (){var G__58614 = parent;
if(cljs.core.contains_QMARK_(opts,new cljs.core.Keyword(null,"default","default",-1987822328))){
return cljs.core.update.cljs$core$IFn$_invoke$arity$5(G__58614,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,attr_key__$1,new cljs.core.Keyword(null,"default","default",-1987822328).cljs$core$IFn$_invoke$arity$1(opts));
} else {
return G__58614;
}
})());
...
var vec__58616 = spec;
var attr_key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58616,(0),null);
var opts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58616,(1),null);
...
datascript.pull_api.filter_reverse_attrs = cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p__58623){
...
datascript.pull_api.pull_expand_reverse_frame = (function datascript$pull_api$pull_expand_reverse_frame(db,p__58628){
...
var frame = first__58631;
var frames = seq__58630__$1;
...
datascript.pull_api.pull_expand_frame = (function datascript$pull_api$pull_expand_frame(db,p__58635){
...
var frame = first__58638;
var frames = seq__58637__$1;
...
var vec__58639 = cljs.core.first(datoms_by_attr);
var attr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58639,(0),null);
var datoms = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58639,(1),null);
...
var attr = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58642__$1,new cljs.core.Keyword(null,"attr","attr",-604132353));
var recursion = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58642__$1,new cljs.core.Keyword(null,"recursion","recursion",-749738765));
var rec = (function (){var G__58644 = recursion;
if((!((attr == null)))){
return datascript.pull_api.push_recursion(G__58644,attr,eid);
} else {
return G__58644;
}
})();
...
var eid = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58647__$1,new cljs.core.Keyword(null,"eid","eid",559519930));
var pattern = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58647__$1,new cljs.core.Keyword(null,"pattern","pattern",242135423));
...
datascript.pull_api.pull_pattern_frame = (function datascript$pull_api$pull_pattern_frame(db,p__58649){
while(true){
var vec__58650 = p__58649;
var seq__58651 = cljs.core.seq(vec__58650);
var first__58652 = cljs.core.first(seq__58651);
var seq__58651__$1 = cljs.core.next(seq__58651);
var frame = first__58652;
var frames = seq__58651__$1;
var temp__5733__auto__ = cljs.core.seq(new cljs.core.Keyword(null,"eids","eids",1546550700).cljs$core$IFn$_invoke$arity$1(frame));
if(temp__5733__auto__){
var eids = temp__5733__auto__;
...
var G__58698 = db;
var G__58699 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,datascript.pull_api.reset_frame(frame,cljs.core.rest(eids),cljs.core.not_empty(cljs.core.persistent_BANG_(new cljs.core.Keyword(null,"kvps","kvps",65308317).cljs$core$IFn$_invoke$arity$1(frame)))));
db = G__58698;
p__58649 = G__58699;
continue;
}
...
while(true){
var G__58654 = new cljs.core.Keyword(null,"state","state",-1988618099).cljs$core$IFn$_invoke$arity$1(cljs.core.first(frames));
var G__58654__$1 = (((G__58654 instanceof cljs.core.Keyword))?G__58654.fqn:null);
switch (G__58654__$1) {
case "expand":
var G__58701 = db;
var G__58702 = datascript.pull_api.pull_expand_frame(db,frames);
db = G__58701;
frames = G__58702;
continue;
...
case "expand-rev":
var G__58703 = db;
var G__58704 = datascript.pull_api.pull_expand_reverse_frame(db,frames);
db = G__58703;
frames = G__58704;
continue;
...
case "pattern":
var G__58705 = db;
var G__58706 = datascript.pull_api.pull_pattern_frame(db,frames);
db = G__58705;
frames = G__58706;
continue;
...
case "recursion":
var G__58707 = db;
var G__58708 = datascript.pull_api.pull_recursion_frame(db,frames);
db = G__58707;
frames = G__58708;
continue;
...
var f = first__58657;
var remaining = seq__58656__$1;
var result = (function (){var G__58658 = cljs.core.persistent_BANG_(new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(f));
if(cljs.core.not(new cljs.core.Keyword(null,"multi?","multi?",-749311069).cljs$core$IFn$_invoke$arity$1(f))){
return cljs.core.first(G__58658);
} else {
return G__58658;
}
})();
...
var G__58709 = db;
var G__58710 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.rest(remaining),(function (){var G__58659 = cljs.core.first(remaining);
if(cljs.core.truth_(result)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$5(G__58659,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,new cljs.core.Keyword(null,"attr","attr",-604132353).cljs$core$IFn$_invoke$arity$1(f),result);
} else {
return G__58659;
}
})());
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__58654__$1)].join('')));
...
var eids__$1 = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p1__58660_SHARP_){
return datascript.db.entid_strict(db,p1__58660_SHARP_);
})),eids);
