...
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42075__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42075__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42075__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error(error.message,file,line,column);
}catch (e42073){var _e = e42073;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5733__auto___42145 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5733__auto___42145)){
var seen_errors_42146 = temp__5733__auto___42145;
if(cljs.core.truth_(seen_errors_42146.has(self))){
} else {
seen_errors_42146.add(self);

var temp__5735__auto___42147 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5735__auto___42147)){
var sense_42148 = temp__5735__auto___42147;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_42148)].join(''));
} else {
}
}
} else {
