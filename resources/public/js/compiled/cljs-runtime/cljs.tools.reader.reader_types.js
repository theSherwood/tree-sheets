...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_42354 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_42354(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_42355 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_42355(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_42356 = (function (reader,ch){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_42356(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_42357 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_42357(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_42358 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_42358(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_42362 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_42362(reader);
}
});
...
var G__42395 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__42396 = s.append(c);
c = G__42395;
s = G__42396;
continue;
}
