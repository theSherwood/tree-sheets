...
var o41327 = temp__5733__auto__;
var temp__5733__auto____$1 = (o41327["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o41328 = temp__5733__auto____$1;
return (o41328["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__41126__auto__ = f;
return (o__41126__auto__["toString"]).call(o__41126__auto__);
} else {
return "";
}
}catch (e41340){var _ = e41340;
return "";
}});
...
try{var o__41126__auto___42040 = t;
(o__41126__auto___42040["cljs$lang$ctorPrWriter"]).call(o__41126__auto___42040,t,writer);
}catch (e41353){var __42041 = e41353;
}
...
var char_code = (function (){var o__41126__auto__ = (new String(char$));
return (o__41126__auto__["charCodeAt"]).call(o__41126__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__41126__auto__ = String;
return (o__41126__auto__["fromCharCode"]).call(o__41126__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__41385 = num_code;
switch (G__41385) {
case (1):
return (185);
...
var o__41126__auto__ = String;
return (o__41126__auto__["fromCharCode"]).call(o__41126__auto__,superscript_code);
});
/**
...
}catch (e41417){var _e__41155__auto__ = e41417;
return false;
}})())){
...
var vec__41422 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41422,(0),null);
...
var len__4736__auto___42071 = arguments.length;
var i__4737__auto___42072 = (0);
while(true){
if((i__4737__auto___42072 < len__4736__auto___42071)){
args__4742__auto__.push((arguments[i__4737__auto___42072]));

var G__42074 = (i__4737__auto___42072 + (1));
i__4737__auto___42072 = G__42074;
continue;
} else {
}
break;
...
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41481,(0),null);
...
var G__42077 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__42078 = cljs.core.butlast(remaining_tokens);
name_tokens = G__42077;
remaining_tokens = G__42078;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq41455){
var G__41461 = cljs.core.first(seq41455);
var seq41455__$1 = cljs.core.next(seq41455);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41461,seq41455__$1);
}));
...
var vec__41515 = cljs.core.split_with((function (p1__41512_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__41512_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41515,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41515,(1),null);
...
var vec__41541 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41541,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41541,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__42091 = cljs.core.rest(remaining_tokens);
var G__42092 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__42091;
name_tokens = G__42092;
continue;
} else {
...
var vec__41564 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41564,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41564,(1),null);
var vec__41567 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41567,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41567,(1),null);
var vec__41570 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41570,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41570,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41570,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41570,(3),null);
...
var vec__41607 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41607,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41607,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41607,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41607,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41607,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41607,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__41649 = temp__5733__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41649,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41649,(1),null);
var vec__41656 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41656,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41656,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__41685 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__41685) : devtools.munging.parse_fn_info_deep.call(null,G__41685));
})()));
}
} else {
return fn_info;
...
var G__42156 = (arity + (1));
var G__42157 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__41738){
var vec__41748 = p__41738;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41748,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41748,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__41786_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__41786_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__41787_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__41787_SHARP_);
}),sorted_infos);
...
var args__4742__auto__ = [];
var len__4736__auto___42166 = arguments.length;
var i__4737__auto___42167 = (0);
while(true){
if((i__4737__auto___42167 < len__4736__auto___42166)){
args__4742__auto__.push((arguments[i__4737__auto___42167]));

var G__42169 = (i__4737__auto___42167 + (1));
i__4737__auto___42167 = G__42169;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__41814){
var vec__41815 = p__41814;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41815,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq41796){
var G__41797 = cljs.core.first(seq41796);
var seq41796__$1 = cljs.core.next(seq41796);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41797,seq41796__$1);
}));
...
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41904__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41904__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41904__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41904__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__41905 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41905,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41905,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41905,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41905,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41905,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41905,(5),null);
...
var o__41126__auto__ = f;
return (o__41126__auto__["getBasis"]).call(o__41126__auto__);
});
/**
...
}catch (e41926){var _e__41155__auto__ = e41926;
...
var G__42207 = (obj[cljs.core.first(path)]);
var G__42208 = cljs.core.rest(path);
obj = G__42207;
path = G__42208;
continue;
} else {
...
var _STAR_ = (function (accum,p__41961){
var vec__41963 = p__41961;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41963,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41963,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__41983){
var vec__41998 = p__41983;
...
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41998,(2),null);
...
var post_process = (function (p__42017){
var vec__42018 = p__42017;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42018,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42018,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__42011_SHARP_){
return (obj[cljs.core.first(p1__42011_SHARP_)]);
}),sorted_matches);
