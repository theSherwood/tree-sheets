...
}catch (e47060){var _e__41155__auto__ = e47060;
return false;
...
}catch (e47075){var _e__41155__auto__ = e47075;
return false;
...
}catch (e47115){var _e__41155__auto__ = e47115;
return false;
...
}catch (e47135){var _e__41155__auto__ = e47135;
return false;
...
}catch (e47151){var _e__41155__auto__ = e47151;
return false;
}})())){
...
}catch (e47158){var _e__41155__auto__ = e47158;
return false;
}})())){
...
var _STAR_current_state_STAR__orig_val__47196 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__47198 = (function (){var or__4126__auto__ = config;
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
} else {
...
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__47198);

try{return (raw_fn.cljs$core$IFn$_invoke$arity$1 ? raw_fn.cljs$core$IFn$_invoke$arity$1(value) : raw_fn.call(null,value));
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__47196);
}});
});
...
return (function() { 
var G__47244__delegate = function (args){
...
while (G__47246__i < G__47246__a.length) {G__47246__a[G__47246__i] = arguments[G__47246__i + 0]; ++G__47246__i;}
  args = new cljs.core.IndexedSeq(G__47246__a,0,null);
} 
return G__47244__delegate.call(this,args);};
G__47244.cljs$lang$maxFixedArity = 0;
G__47244.cljs$lang$applyTo = (function (arglist__47248){
var args = cljs.core.seq(arglist__47248);
return G__47244__delegate(args);
});
