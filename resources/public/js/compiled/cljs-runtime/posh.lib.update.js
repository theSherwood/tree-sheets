...
posh.lib.update.update_pull = (function posh$lib$update$update_pull(p__56191,storage_key){
var map__56193 = p__56191;
...
var posh_tree = map__56193__$1;
var dcfg = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56193__$1,new cljs.core.Keyword(null,"dcfg","dcfg",-880371016));
var retrieve = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56193__$1,new cljs.core.Keyword(null,"retrieve","retrieve",-657129560));
var vec__56195 = storage_key;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56195,(0),null);
var poshdb = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56195,(1),null);
var pull_pattern = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56195,(2),null);
var eid = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56195,(3),null);
...
posh.lib.update.update_filter_pull = (function posh$lib$update$update_filter_pull(p__56201,storage_key){
...
var posh_tree = map__56202__$1;
var dcfg = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56202__$1,new cljs.core.Keyword(null,"dcfg","dcfg",-880371016));
var retrieve = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56202__$1,new cljs.core.Keyword(null,"retrieve","retrieve",-657129560));
var vec__56206 = storage_key;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56206,(0),null);
var poshdb = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56206,(1),null);
var pull_pattern = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56206,(2),null);
var eid = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56206,(3),null);
...
posh.lib.update.update_pull_many = (function posh$lib$update$update_pull_many(p__56213,storage_key){
...
var posh_tree = map__56214__$1;
var dcfg = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56214__$1,new cljs.core.Keyword(null,"dcfg","dcfg",-880371016));
var retrieve = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56214__$1,new cljs.core.Keyword(null,"retrieve","retrieve",-657129560));
var vec__56216 = storage_key;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56216,(0),null);
var poshdb = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56216,(1),null);
var pull_pattern = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56216,(2),null);
var eids = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56216,(3),null);
...
posh.lib.update.update_q_with_dbvarmap = (function posh$lib$update$update_q_with_dbvarmap(p__56219,storage_key){
...
var posh_tree = map__56220__$1;
var dcfg = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56220__$1,new cljs.core.Keyword(null,"dcfg","dcfg",-880371016));
var retrieve = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56220__$1,new cljs.core.Keyword(null,"retrieve","retrieve",-657129560));

var vec__56222 = storage_key;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56222,(0),null);
var query = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56222,(1),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56222,(2),null);
...
var poshdbmap = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.merge,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__56225){
var vec__56226 = p__56225;
var db_sym = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56226,(0),null);
var poshdb = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56226,(1),null);
return cljs.core.PersistentArrayMap.createAsIfByAssoc([db_sym,posh.lib.db.poshdb__GT_analyze_db(posh_tree,poshdb)]);
}),dbvarmap));
var fixed_args = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__56229){
var vec__56230 = p__56229;
var sym = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56230,(0),null);
var arg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56230,(1),null);
...
var G__56233 = cljs.core.first(storage_key);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__56233__$1)].join('')));
